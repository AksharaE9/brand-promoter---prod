        ...
        <div className="min-h-screen bg-[#f8fbff] flex flex-col items-center justify-center p-6 bg-[radial-gradient(circle_at_20%_20%,#eef2ff_0,transparent_25%),radial-gradient(circle_at_80%_80%,#ecfdf5_0,transparent_25%)]">
            <PageEnter>
                <div className="text-center mb-12">
                    <div className="inline-flex items-center gap-3 mb-6 reveal-fade">
                    ...
                    {workspaces.map((ws, idx) => (
                        <Reveal key={ws.id} delay={idx * 0.1}>
                            <div
                                ...
                                className="os-card p-1.5 cursor-pointer group bg-white border-none shadow-[0_32px_64px_-16px_rgba(0,0,0,0.08)] hover:shadow-[0_48px_80px_-16px_rgba(0,0,0,0.12)] hover:-translate-y-2.5 hover:scale-[1.02] transition-all duration-300 rounded-[40px] overflow-hidden"
                            >
